// Mindmap viewer — ELK/geometry layout engine (pure functions) + tree-visibility helpers.
...
export {
  elk,
  assignBranchColors, assignBranchMeta, balanceBranchSides, boxesOverlap, buildChildrenMap,
  buildParentMap, buildRouteWithAttachedEndpoints, centerFinalLayout, centerLayout,
  clampExtremeOutliers, cleanRoutePoints, collectVisibleDescendants, countNodeOverlaps,
  countSharedSegments, createBundledMindmapEdges, createProfessionalEdges, createSmartRoutedEdges,
  createSmartRoutedEdgesFallback, ELK_CONFIGS, ensureSafeLayout, getAdaptiveNodeSize,
  getAdaptiveSpacing, getAncestorIds, getBestHandlePair, getBranchLane, getDescendantIdsLimited,
  getElkOptions, getExitPointFromHandle, getExpandedHandlePoint, getFocusNodeIds, getGraphBounds,
  getHandleCandidates, getHandlePoint, getManhattanLength, getNaturalHandlePair, getNodeBox,
  getNodeCenter, getNodeRect, getOverviewNodeIds, getPortOffset, getProfessionalEdgeStyle,
  getProfessionalEdgeVisual, getRawHandlePoint, getRootNodeFromPositioned, getRootToBranchHandle,
  getSideVector, getSourceHandleId, getSubtreeSize, getTargetHandleId, getVisibleNodeIds,
  isCollinear, isFinitePoint, layoutCleanMindmap, layoutCompactMindmap, layoutPresentationMap,
  layoutSafeLayeredTree, layoutTreeCompact, makeRouteCandidates, mergeManualPositions,
  moveSubtreesToSides, normalizeBranchVerticalCenter, normalizeSegment, onSegment,
  orderBranchesForBalancedMindmap, orientation, pathIntersectsNodeRects, pickBestHandleAndRoute,
  placeNodeNearParent, placeOrphans, pointInRect, registerRouteSegments, resolveFinalOverlaps,
  resolveNodeOverlapsByDepth, resolveVerticalOverlaps, roundedPolylinePath, routeBundledEdge,
  samePoint, sanitizeEdges, sanitizeRawEdges, scoreRoute, segmentIntersectsRect, segmentsIntersect,
  shouldShowTreeEdge, sortChildrenForLayout, splitBranchesBalanced, splitBranchesBalancedByHeight,
  stabilizeLayout, subtreeHeight, translateNodes,
};
